...
public class ConfigManager : MonoBehaviour {
	...
	public float orbitSpeedInDaysPerSecond;
	...
	public void SetDefaultLightPositionForOrbitCamera()
	{
		GameObject.Find(ConstantValues.SunLight).GetComponent<Light>().transform.rotation = DefaultValues.OrbitCameraLightPosition();
	}
}
