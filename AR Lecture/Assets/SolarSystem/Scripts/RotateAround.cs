...
public class RotateAround : MonoBehaviour {
	...
	void LateUpdate () {
        ...
        transform.RotateAround(centerMass.position, Vector3.up, Time.deltaTime * ((defaultEarthYear / rotationAroundSunDays) * (ConfigManager.instance.orbitSpeedInDaysPerSecond)));
